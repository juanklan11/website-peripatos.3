...
class BaseView(with_metaclass(AdminViewMeta, BaseViewClass)):
    """
        ...
        Icons can be added to the menu by using `menu_icon_type` and `menu_icon_value`. For example::
            ...
            admin1.add_view(MyView(name='My View', menu_icon_type='glyph', menu_icon_value='glyphicon-home'))
    """
    @property
    ...
    def __init__(self, name=None, category=None, endpoint=None, url=None,
        ...
        """
            ...
            :param url:
                ...
                is "test", the resulting URL will look like "/admin1/test/". If not provided, will
                use endpoint as a base url. However, if URL starts with '/', absolute path is assumed
                and '/admin1/' prefix won't be applied.
        ...
        if self._default_view is None:
            raise Exception(u'Attempted to instantiate admin1 view %s without default view' % self.__class__.__name__)
    ...
    def create_blueprint(self, admin):
        ...
        """
        # Store admin1 instance
        self.admin = admin

        # If the static_url_path is not provided, use the admin1's
        ...
        if self.url == '/':
            self.url = None
            # prevent admin1 static files from conflicting with flask static files
            if not self.static_url_path:
...
class AdminIndexView(BaseView):
    """
        Default administrative interface index page when visiting the ``/admin1/`` URL.
        ...
        It can be overridden by passing your own view class to the ``Admin`` constructor::
            ...
            class MyHomeView(AdminIndexView):
                ...
                def index(self):
                    arg1 = 'Hello'
                    return self.render('admin1/myhome.html', arg1=arg1)

            admin1 = Admin(index_view=MyHomeView())


        Also, you can change the root url from /admin1 to / with the following::

            admin1 = Admin(
                app,
                index_view=AdminIndexView(
                    name='Home',
                    template='admin1/myhome.html',
                    url='/'
                )
            )
        ...
        * If an endpoint is not provided, will default to ``admin1``
        * Default URL route is ``/admin1``.
        * Automatically associates with static folder.
        * Default template is ``admin1/index.html``
    """
    def __init__(self, name=None, category=None,
                 endpoint=None, url=None,
                 template='admin1/index.html',
        ...
        super(AdminIndexView, self).__init__(name or babel.lazy_gettext('Home'),
                                             category,
                                             endpoint or 'admin1',
                                             '/admin1' if url is None else url,
                                             'static',
...
class Admin(object):
    """
        Collection of the admin1 views. Also manages menu structure.
    """
    def __init__(self, app=None, name=None,
        ...
        """
            ...
            :param base_template:
                Override base HTML template for all static views. Defaults to `admin1/base.html`.
            :param template_mode:
        ...
        self.base_template = base_template or 'admin1/base.html'
    ...
    def add_views(self, *args):
        """
            ...
            Examples::
                ...
                admin1.add_views(view1)
                admin1.add_views(view1, view2, view3, view4)
                admin1.add_views(*my_list)
    ...
    def add_links(self, *args):
        """
            ...
            Examples::
                ...
                admin1.add_links(link1)
                admin1.add_links(link1, link2, link3, link4)
                admin1.add_links(*my_list)
    ...
    def _init_extension(self):
        ...
        admins = self.app.extensions.get('admin1', [])
        ...
        admins.append(self)
        self.app.extensions['admin1'] = admins
