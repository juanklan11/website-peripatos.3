...
class BaseFileAdmin(BaseView, ActionsMixin):
    ...
    list_template = 'admin1/file/list.html'
    """
        File list template
    """

    upload_template = 'admin1/file/form.html'
    """
        File upload template
    """

    upload_modal_template = 'admin1/file/modals/form.html'
    """
        File upload template for modal dialog
    """

    mkdir_template = 'admin1/file/form.html'
    """
        Directory creation (mkdir) template
    """

    mkdir_modal_template = 'admin1/file/modals/form.html'
    """
        Directory creation (mkdir) template for modal dialog
    """

    rename_template = 'admin1/file/form.html'
    """
        Rename template
    """

    rename_modal_template = 'admin1/file/modals/form.html'
    """
        Rename template for modal dialog
    """

    edit_template = 'admin1/file/form.html'
    """
        Edit template
    """

    edit_modal_template = 'admin1/file/modals/form.html'
    """
    ...
    def upload_form(self):
        ...
        if request.form:
            ...
            # admin1=self allows the form to use self.is_file_allowed
...
class FileAdmin(BaseFileAdmin):
    """
        ...
        Sample usage::
            ...
            admin1.add_view(FileAdmin(path, '/static/', name='Static Files'))
    """
