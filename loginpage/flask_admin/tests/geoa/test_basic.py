...
def test_model():
    ...
    rv = client.get('/admin1/geomodel/')
    eq_(rv.status_code, 200)

    rv = client.get('/admin1/geomodel/new/')
    eq_(rv.status_code, 200)

    rv = client.post('/admin1/geomodel/new/', data={
        "name": "test1",
    ...
    url = '/admin1/geomodel/edit/?id=%s' % model.id
    rv = client.get(url)
    eq_(rv.status_code, 200)
    ...
    url = '/admin1/geomodel/delete/?id=%s' % model.id
    rv = client.post(url)
    eq_(rv.status_code, 302)
