...
def test_model():
    ...
    rv = client.get('/admin1/model1/')
    eq_(rv.status_code, 200)

    # check that we can retrieve a 'create' view
    rv = client.get('/admin1/model1/new/')
    eq_(rv.status_code, 200)
    ...
    url = '/admin1/model1/edit/?id=%s' % model.id
    rv = client.get(url)
    eq_(rv.status_code, 200)
    ...
    url = '/admin1/model1/delete/?id=%s' % model.id
    rv = client.post(url)
    eq_(rv.status_code, 302)
...
def test_column_searchable_list():
    ...
    rv = client.get('/admin1/model2/?search=model1')
    data = rv.data.decode('utf-8')
    ok_('model1-test' in data)
    ok_('model2-test' not in data)

    rv = client.get('/admin1/model2/?search=9000')
    data = rv.data.decode('utf-8')
...
def test_extra_args_search():
    ...
    rv = client.get('/admin1/model1/?search=model1&foo=bar')
    data = rv.data.decode('utf-8')
...
def test_extra_args_filter():
    ...
    rv = client.get('/admin1/model2/?flt1_0=5000&foo=bar')
    data = rv.data.decode('utf-8')
    ok_('<input type="hidden" name="foo" value="bar">' in data)
...
def test_complex_searchable_list():
    ...
    rv = client.get('/admin1/model2/?search=model1-test1')
    data = rv.data.decode('utf-8')
    ...
    rv = client.get('/admin1/model1/?search=model2-test1')
    data = rv.data.decode('utf-8')
...
def test_complex_searchable_list_missing_children():
    ...
    rv = client.get('/admin1/model1/?search=magic')
    data = rv.data.decode('utf-8')
...
def test_column_editable_list():
    ...
    rv = client.post('/admin1/model1/ajax/update/', data={
        'list_form_pk': '1',
    ...
    rv = client.post('/admin1/model2/ajax/update/', data={
        'list_form_pk': '1',
        'model1': '3',
    })
    data = rv.data.decode('utf-8')
...
def test_details_view():
    ...
    rv = client.get('/admin1/model1/')
    data = rv.data.decode('utf-8')
    ok_('/admin1/model1/details/' not in data)

    # ensure link to details view appears
    rv = client.get('/admin1/model2/')
    data = rv.data.decode('utf-8')
    ok_('/admin1/model2/details/' in data)

    # test redirection when details are disabled
    rv = client.get('/admin1/model1/details/?url=%2Fadmin%2Fmodel1%2F&id=1')
    eq_(rv.status_code, 302)

    # test if correct data appears in details view when enabled
    rv = client.get('/admin1/model2/details/?url=%2Fadmin%2Fmodel2%2F&id=1')
    data = rv.data.decode('utf-8')
    ...
    rv = client.get('/admin1/sf_view/details/?url=%2Fadmin%2Fsf_view%2F&id=1')
    data = rv.data.decode('utf-8')
    ok_('String Field' in data)
    ok_('test2_val_1' in data)
...
def test_column_filters():
    ...
    # Test equals
    rv = client.get('/admin1/model1/?flt0_0=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # Test NOT IN filter
    rv = client.get('/admin1/model1/?flt0_6=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # string - equals
    rv = client.get('/admin1/_strings/?flt0_0=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test1_val_2' not in data)
    ...
    # string - not equal
    rv = client.get('/admin1/_strings/?flt0_1=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test1_val_2' in data)
    ...
    # string - contains
    rv = client.get('/admin1/_strings/?flt0_2=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test1_val_2' not in data)
    ...
    # string - not contains
    rv = client.get('/admin1/_strings/?flt0_3=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test1_val_2' in data)
    ...
    # string - empty
    rv = client.get('/admin1/_strings/?flt0_4=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # string - not empty
    rv = client.get('/admin1/_strings/?flt0_4=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # string - in list
    rv = client.get('/admin1/_strings/?flt0_5=test1_val_1%2Ctest1_val_2')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ...
    # string - not in list
    rv = client.get('/admin1/_strings/?flt0_6=test1_val_1%2Ctest1_val_2')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ...
    # integer - equals
    rv = client.get('/admin1/model2/?flt0_0=5000')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    rv = client.get('/admin1/model2/?flt0_0=6169453081680413441')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    rv = client.get('/admin1/model2/?flt0_0=badval')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('Invalid Filter Value' in data)

    # integer - not equal
    rv = client.get('/admin1/model2/?flt0_1=5000')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # integer - greater
    rv = client.get('/admin1/model2/?flt0_2=6000')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_3' not in data)
    ok_('test2_val_4' in data)
    ...
    # integer - smaller
    rv = client.get('/admin1/model2/?flt0_3=6000')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_3' in data)
    ok_('test2_val_4' not in data)
    ...
    # integer - empty
    rv = client.get('/admin1/model2/?flt0_4=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test2_val_2' in data)
    ...
    # integer - not empty
    rv = client.get('/admin1/model2/?flt0_4=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test2_val_2' not in data)
    ...
    # integer - in list
    rv = client.get('/admin1/model2/?flt0_5=5000%2C9000')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test2_val_2' not in data)
    ...
    rv = client.get('/admin1/model2/?flt0_5=6169453081680413441')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test2_val_5' in data)
    ...
    rv = client.get('/admin1/model2/?flt0_5=5000%2Cbadval')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('Invalid Filter Value' in data)

    # integer - not in list
    rv = client.get('/admin1/model2/?flt0_6=5000%2C9000')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test2_val_2' in data)
    ...
    # boolean - equals - Yes
    rv = client.get('/admin1/_bools/?flt0_0=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test2_val_2' not in data)
    ...
    # boolean - equals - No
    rv = client.get('/admin1/_bools/?flt0_0=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test2_val_2' in data)
    ...
    rv = client.get('/admin1/_bools/?flt0_1=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test2_val_2' in data)
    ...
    rv = client.get('/admin1/_bools/?flt0_1=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test2_val_2' not in data)
    ...
    # float - equals
    rv = client.get('/admin1/_float/?flt0_0=25.9')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_3' in data)
    ok_('test2_val_4' not in data)
    ...
    rv = client.get('/admin1/_float/?flt0_0=badval')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('Invalid Filter Value' in data)

    # float - not equal
    rv = client.get('/admin1/_float/?flt0_1=25.9')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_3' not in data)
    ok_('test2_val_4' in data)
    ...
    # float - greater
    rv = client.get('/admin1/_float/?flt0_2=60.5')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_3' not in data)
    ok_('test2_val_4' in data)
    ...
    # float - smaller
    rv = client.get('/admin1/_float/?flt0_3=60.5')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_3' in data)
    ok_('test2_val_4' not in data)
    ...
    # float - empty
    rv = client.get('/admin1/_float/?flt0_4=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test2_val_2' in data)
    ...
    # float - not empty
    rv = client.get('/admin1/_float/?flt0_4=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test2_val_2' not in data)
    ...
    # float - in list
    rv = client.get('/admin1/_float/?flt0_5=25.9%2C75.5')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test2_val_2' not in data)
    ...
    rv = client.get('/admin1/_float/?flt0_5=25.9%2Cbadval')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('Invalid Filter Value' in data)

    # float - not in list
    rv = client.get('/admin1/_float/?flt0_6=25.9%2C75.5')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test2_val_2' in data)
    ...
    rv = client.get('/admin1/_model2/?flt1_0=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test2_val_2' not in data)
    ...
    rv = client.get('/admin1/_model3/?flt1_test1_equals=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' in data)
    ok_('test1_val_2' not in data)
    ...
    # date - equals
    rv = client.get('/admin1/_datetime/?flt0_0=2014-11-17')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # date - not equal
    rv = client.get('/admin1/_datetime/?flt0_1=2014-11-17')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # date - greater
    rv = client.get('/admin1/_datetime/?flt0_2=2014-11-16')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('date_obj1' in data)
    ok_('date_obj2' not in data)
    ...
    # date - smaller
    rv = client.get('/admin1/_datetime/?flt0_3=2014-11-16')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('date_obj1' not in data)
    ok_('date_obj2' in data)
    ...
    # date - between
    rv = client.get('/admin1/_datetime/?flt0_4=2014-11-13+to+2014-11-20')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('date_obj1' in data)
    ok_('date_obj2' not in data)
    ...
    # date - not between
    rv = client.get('/admin1/_datetime/?flt0_5=2014-11-13+to+2014-11-20')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('date_obj1' not in data)
    ok_('date_obj2' in data)
    ...
    # date - empty
    rv = client.get('/admin1/_datetime/?flt0_6=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' in data)
    ok_('date_obj1' not in data)
    ...
    # date - empty
    rv = client.get('/admin1/_datetime/?flt0_6=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' not in data)
    ok_('date_obj1' in data)
    ...
    # datetime - equals
    rv = client.get('/admin1/_datetime/?flt0_7=2014-04-03+01%3A09%3A00')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # datetime - not equal
    rv = client.get('/admin1/_datetime/?flt0_8=2014-04-03+01%3A09%3A00')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # datetime - greater
    rv = client.get('/admin1/_datetime/?flt0_9=2014-04-03+01%3A08%3A00')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('datetime_obj1' in data)
    ok_('datetime_obj2' not in data)
    ...
    # datetime - smaller
    rv = client.get('/admin1/_datetime/?flt0_10=2014-04-03+01%3A08%3A00')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('datetime_obj1' not in data)
    ok_('datetime_obj2' in data)
    ...
    # datetime - between
    rv = client.get('/admin1/_datetime/?flt0_11=2014-04-02+00%3A00%3A00+to+2014-11-20+23%3A59%3A59')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('datetime_obj1' in data)
    ok_('datetime_obj2' not in data)
    ...
    rv = client.get('/admin1/_datetime/?flt0_12=2014-04-02+00%3A00%3A00+to+2014-11-20+23%3A59%3A59')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('datetime_obj1' not in data)
    ok_('datetime_obj2' in data)
    ...
    # datetime - empty
    rv = client.get('/admin1/_datetime/?flt0_13=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' in data)
    ok_('datetime_obj1' not in data)
    ...
    # datetime - not empty
    rv = client.get('/admin1/_datetime/?flt0_13=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' not in data)
    ok_('datetime_obj1' in data)
    ...
    # time - equals
    rv = client.get('/admin1/_datetime/?flt0_14=11%3A10%3A09')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # time - not equal
    rv = client.get('/admin1/_datetime/?flt0_15=11%3A10%3A09')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # time - greater
    rv = client.get('/admin1/_datetime/?flt0_16=11%3A09%3A09')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('timeonly_obj1' in data)
    ok_('timeonly_obj2' not in data)
    ...
    # time - smaller
    rv = client.get('/admin1/_datetime/?flt0_17=11%3A09%3A09')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('timeonly_obj1' not in data)
    ok_('timeonly_obj2' in data)
    ...
    # time - between
    rv = client.get('/admin1/_datetime/?flt0_18=10%3A40%3A00+to+11%3A50%3A59')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('timeonly_obj1' in data)
    ok_('timeonly_obj2' not in data)
    ...
    # time - not between
    rv = client.get('/admin1/_datetime/?flt0_19=10%3A40%3A00+to+11%3A50%3A59')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('timeonly_obj1' not in data)
    ok_('timeonly_obj2' in data)
    ...
    # time - empty
    rv = client.get('/admin1/_datetime/?flt0_20=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' in data)
    ok_('timeonly_obj1' not in data)
    ...
    # time - not empty
    rv = client.get('/admin1/_datetime/?flt0_20=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' not in data)
    ok_('timeonly_obj1' in data)
    ...
    # enum - equals
    rv = client.get('/admin1/_enumfield/?flt0_0=model1_v1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # enum - not equal
    rv = client.get('/admin1/_enumfield/?flt0_1=model1_v1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # enum - empty
    rv = client.get('/admin1/_enumfield/?flt0_2=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' in data)
    ok_('enum_obj1' not in data)
    ...
    # enum - not empty
    rv = client.get('/admin1/_enumfield/?flt0_2=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' not in data)
    ok_('enum_obj1' in data)
    ...
    # enum - in list
    rv = client.get('/admin1/_enumfield/?flt0_3=model1_v1%2Cmodel1_v2')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' not in data)
    ok_('enum_obj1' in data)
    ...
    # enum - not in list
    rv = client.get('/admin1/_enumfield/?flt0_4=model1_v1%2Cmodel1_v2')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1_val_1' in data)
    ok_('enum_obj1' not in data)
    ...
    rv = client.get('/admin1/_relation_test/?flt1_0=test1_val_1')
    data = rv.data.decode('utf-8')
...
def test_hybrid_property():
    ...
    rv = client.get('/admin1/model1/?flt0_0=600')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # sorting
    rv = client.get('/admin1/model1/?sort=0')
    eq_(rv.status_code, 200)
    ...
    # searching
    rv = client.get('/admin1/model1/?search=100')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
...
def test_url_args():
    ...
    # page
    rv = client.get('/admin1/model1/?page=1')
    data = rv.data.decode('utf-8')
    ok_('data1' not in data)
    ok_('data3' in data)

    # sort
    rv = client.get('/admin1/model1/?sort=0&desc=1')
    data = rv.data.decode('utf-8')
    ok_('data1' not in data)
    ok_('data3' in data)
    ok_('data4' in data)
    ...
    # search
    rv = client.get('/admin1/model1/?search=data1')
    data = rv.data.decode('utf-8')
    ok_('data1' in data)
    ...
    # like
    rv = client.get('/admin1/model1/?flt0=0&flt0v=data1')
    data = rv.data.decode('utf-8')
    ok_('data1' in data)

    # not like
    rv = client.get('/admin1/model1/?flt0=1&flt0v=data1')
    data = rv.data.decode('utf-8')
    ok_('data2' in data)
...
def test_non_int_pk():
    ...
    rv = client.get('/admin1/model/')
    eq_(rv.status_code, 200)

    rv = client.post('/admin1/model/new/',
    ...
    rv = client.get('/admin1/model/edit/?id=test1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2' in data)
...
def test_multiple_delete():
    ...
    rv = client.post('/admin1/model1/action/', data=dict(action='delete', rowid=[1, 2, 3]))
    eq_(rv.status_code, 302)
...
def test_complex_sort():
    ...
    rv = client.get('/admin1/model2/?sort=0')
    eq_(rv.status_code, 200)
    ...
    rv = client.get('/admin1/m1_2/?sort=0')
    eq_(rv.status_code, 200)
...
def test_ajax_fk():
    ...
    with app.test_request_context('/admin1/view/'):
    ...
    req = client.get(u'/admin1/view/ajax/lookup/?name=model1&query=foo')
    eq_(req.data.decode('utf-8'), u'[[%s, "foo"]]' % model2.id)

    # Check submitting
    req = client.post('/admin1/view/new/', data={u'model1': as_unicode(model.id)})
...
def test_ajax_fk_multi():
    ...
    # Check submitting
    client = app.test_client()
    client.post('/admin1/view/new/', data={u'model1': as_unicode(model.id)})
    mdl = db.session.query(Model2).first()
...
def test_safe_redirect():
    ...
    rv = client.post('/admin1/model1/new/?url=http://localhost/admin/model2view/',
                     data=dict(test1='test1large', test2='test2',
    ...
    rv = client.post('/admin1/model1/new/?url=http://google.com/evil/',
                     data=dict(test1='test1large', test2='test2',
                               _continue_editing='Save and Continue Editing'))
...
def test_model_default():
    ...
    client = app.test_client()
    rv = client.post('/admin1/model2/new/', data=dict())
...
def test_export_csv():
    ...
    rv = client.get('/admin1/row_limit_2/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_("Test1,Test2\r\n"
    ...
    rv = client.get('/admin1/no_row_limit/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
