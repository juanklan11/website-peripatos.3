...
def test_mockview():
    ...
    rv = client.get('/admin1/model/new/')
    eq_(rv.status_code, 200)
    ...
    # Try model edit view
    rv = client.get('/admin1/model/edit/?id=3')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test1' in data)

    rv = client.post('/admin1/model/edit/?id=3',
    ...
    rv = client.get('/admin1/model/edit/?id=4')
    eq_(rv.status_code, 302)

    # Attempt to delete model
    rv = client.post('/admin1/model/delete/?id=3')
    eq_(rv.status_code, 302)
    ...
    app_iter, status, headers = dispatched_client.post(
        '/dispatched/admin1/model/edit/?id=3',
...
def test_permissions():
    ...
    view.can_edit = False
    rv = client.get('/admin1/model/edit/?id=1')
    eq_(rv.status_code, 302)

    view.can_delete = False
    rv = client.post('/admin1/model/delete/?id=1')
    eq_(rv.status_code, 302)
...
def test_csrf():
    ...
    # create_view
    ################
    rv = client.get('/admin1/secure/new/')
    eq_(rv.status_code, 200)
    ...
    rv = client.post('/admin1/secure/new/', data=dict(name='test1'))
    eq_(rv.status_code, 200)
    ...
    # edit_view
    ###############
    rv = client.get('/admin1/secure/edit/?url=%2Fadmin%2Fsecure%2F&id=1')
    eq_(rv.status_code, 200)
    ok_(u'name="csrf_token"' in rv.data.decode('utf-8'))
    ...
    rv = client.post('/admin1/secure/edit/?url=%2Fadmin%2Fsecure%2F&id=1',
    ...
    rv = client.post('/admin1/secure/delete/',
                     data=dict(id="1", url="/admin1/secure/"), follow_redirects=True)
    eq_(rv.status_code, 200)
    ...
    rv = client.post('/admin1/secure/delete/',
                     data=dict(id="1", url="/admin1/secure/", csrf_token=csrf_token),
    ...
    # Delete without CSRF token, test validation errors
    rv = client.post('/admin1/secure/action/',
                     data=dict(rowid='1', url='/admin1/secure/', action='delete'),
                     follow_redirects=True)
    eq_(rv.status_code, 200)
    ok_(u'Record was successfully deleted.' not in rv.data.decode('utf-8'))
...
def test_modal_edit():
    ...
    rv = client_bs3.get('/admin1/edit_modal_on/')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('fa_modal_window' in data)

    # bootstrap 3 - test modal disabled
    rv = client_bs3.get('/admin1/edit_modal_off/')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('fa_modal_window' not in data)

    # bootstrap 3 - ensure modal window is added when edit_modal is enabled
    rv = client_bs3.get('/admin1/create_modal_on/')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('fa_modal_window' in data)

    # bootstrap 3 - test modal disabled
    rv = client_bs3.get('/admin1/create_modal_off/')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('fa_modal_window' not in data)
...
def test_export_csv():
    ...
    rv = client.get('/admin1/test/export/csv/')
    eq_(rv.status_code, 302)
    ...
    rv = client.get('/admin1/model/export/csv/')
    data = rv.data.decode('utf-8')
    ...
    rv = client.get('/admin1/exportinclusion/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.mimetype, 'text/csv')
    eq_(rv.status_code, 200)
    ok_("Id,Col1,Col2\r\n"
    ...
    rv = client.get('/admin1/exportexclusion/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.mimetype, 'text/csv')
    eq_(rv.status_code, 200)
    ok_("Col1\r\n"
    ...
    rv = client.get('/admin1/utf8/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_(u'\u2013ut8_1\u2013,\u2013utf8_2\u2013\r\n' in data)
    ...
    rv = client.get('/admin1/types_and_formatters/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ...
    rv = client.get('/admin1/export_types_and_formatters/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_("Col1,Col2\r\n"
        "col1_1,3\r\n"
    ...
    rv = client.get('/admin1/macro_exception/export/csv/')
    data = rv.data.decode('utf-8')
    ...
    rv = client.get('/admin1/macro_exception_formatter_override/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_("Col1,Col2\r\n"
        "col1_1,1\r\n"
    ...
    rv = client.get('/admin1/macro_exception_exclude_override/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_("Col2\r\n"
        "1\r\n"
    ...
    rv = client.get('/admin1/macro_exception_list_override/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_("Col2\r\n"
        "1\r\n"
    ...
    rv = client.get('/admin1/macro_exception_macro_override/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 500)
