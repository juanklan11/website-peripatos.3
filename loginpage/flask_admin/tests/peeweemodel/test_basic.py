...
def test_model():
    ...
    rv = client.post('/admin1/model1/new/',
...
def test_details_view():
    ...
    rv = client.get('/admin1/model1/details/?url=%2Fadmin%2Fmodel1%2F&id=3')
    eq_(rv.status_code, 302)

    # test if correct data appears in details view when enabled
    rv = client.get('/admin1/model2/details/?url=%2Fadmin%2Fmodel2%2F&id=3')
    data = rv.data.decode('utf-8')
    ...
    rv = client.get('/admin1/cf_view/details/?url=%2Fadmin%2Fcf_view%2F&id=3')
    data = rv.data.decode('utf-8')
    ok_('Char Field' in data)
    ok_('char_field_val_3' in data)
...
def test_column_filters():
    ...
    # string - not equal
    rv = client.get('/admin1/model1/?flt0_1=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # string - contains
    rv = client.get('/admin1/model1/?flt0_2=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ok_('test1_val_2' not in data)
    ...
    # string - not contains
    rv = client.get('/admin1/model1/?flt0_3=test1_val_1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
    ok_('test1_val_2' in data)
    ...
    # string - empty
    rv = client.get('/admin1/model1/?flt0_4=1')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # string - not empty
    rv = client.get('/admin1/model1/?flt0_4=0')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ...
    # string - in list
    rv = client.get('/admin1/model1/?flt0_5=test1_val_1%2Ctest1_val_2')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' in data)
    ...
    # string - not in list
    rv = client.get('/admin1/model1/?flt0_6=test1_val_1%2Ctest1_val_2')
    eq_(rv.status_code, 200)
    data = rv.data.decode('utf-8')
    ok_('test2_val_1' not in data)
