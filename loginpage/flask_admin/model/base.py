...
class BaseModelView(BaseView, ActionsMixin):
    ...
    # Templates
    list_template = 'admin1/model/list.html'
    """Default list view template"""

    edit_template = 'admin1/model/edit.html'
    """Default edit template"""

    create_template = 'admin1/model/create.html'
    """Default create template"""

    details_template = 'admin1/model/details.html'
    """Default details view template"""

    # Modal Templates
    edit_modal_template = 'admin1/model/modals/edit.html'
    """Default edit modal template"""

    create_modal_template = 'admin1/model/modals/create.html'
    """Default create modal template"""

    details_modal_template = 'admin1/model/modals/details.html'
    ...
    def on_form_prefill(self, form, id):
        """
            ...
            Flask-admin1 can't figure out by itself. Fields that were
